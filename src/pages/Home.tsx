  ...
  const features = [
    {
      ...
      title: '7 Módulos Pro',
      description: 'Desde fundamentos hasta Power BI. Contenido directo al grano y práctico.',
    },
    {
      ...
      <section className="pt-24 pb-20 px-6 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg text-slate-500 dark:text-slate-400 mb-12 max-w-2xl mx-auto leading-relaxed">
            Aprende la lógica de negocio detrás de la herramienta. Impulsa tu carrera con la metodología de excelencia de IA Academy.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to={token ? "/curso" : "/login"} className="px-8 py-4 bg-emerald-600 text-white rounded-xl font-bold text-lg hover:bg-emerald-700 transition-all flex items-center gap-2 shadow-lg shadow-emerald-200 dark:shadow-none">
